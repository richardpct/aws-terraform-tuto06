...
export TF_VAR_key_network="tuto-05/dev/network/terraform.tfstate"
export TF_VAR_key_bastion="tuto-05/dev/bastion/terraform.tfstate"
export TF_VAR_key_database="tuto-05/dev/database/terraform.tfstate"
export TF_VAR_key_web="tuto-05/dev/web/terraform.tfstate"
